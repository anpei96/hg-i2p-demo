'''
    test of temporal i2p registration in the unseen tum dataset
    data: 06.20.2025
'''
...
'''
    please set tum scene_01/scene_02/scene_03 in the config and data_base_path
'''
from config.tum_scenes_config_ours import make_cfg
data_base_path = ""
data_save_path = "/media/anpei/DiskA/05_i2p_fewshot/results/Tum/"
...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        # ckpt_path = base_path + "our-30-tr-align-act-tf-office-super.pth"
    ...
    def get_log_string(self, iteration, data_dict, output_dict, result_dict):
        scene_name = "tum" #data_dict["scene_name"]
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        if is_need_visulization:
            ...
            for i in range(num):
                ...
                if ((v < 0) | (v >= img_h)):
                    continue
                cv.circle(pts_image, (int(u), int(v)), 2, (b,g,r), -1)
