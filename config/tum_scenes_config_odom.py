...
# data
_C.data = edict()
_C.data.dataset_dir = "/media/anpei/DiskA/05_i2p_fewshot/data/Tum/scene_01/"
...
_C.model.image_backbone.input_dim = 3 # rgb+seg
...
_C.model.point_backbone.input_dim = 3 # rgb+seg
