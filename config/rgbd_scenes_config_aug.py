...
# exp
_C.exp = edict()
_C.exp.name = "output_rgbd_scenes"
...
# data
_C.data = edict()
_C.data.dataset_dir = "/media/anpei/DiskA/05_i2p_fewshot/data/RGBDScenesV2/"
...
_C.model.image_backbone.input_dim = 6 # rgb
...
_C.model.point_backbone.input_dim = 6 # rgb
