...
data_path = "/media/anpei/DiskA/05_i2p_fewshot/data/RGBDScenesV2/data/"
...
def main_batch_process():
    ...
    data_base_path = data_dir+"RGBDScenesV2/data/rgbd-scenes-v2-scene_"
    num_scene = 14
    data_base_path = data_dir+"Scannet/data/scene_"
    num_scene = 10
    # data_base_path = data_dir+"Fangwei/data/scene_"
    # num_scene = 11

    for idx in range(num_scene):
        # idx = idx + 1
        spec_path = data_base_path + str("%02d" % idx) + "/"
