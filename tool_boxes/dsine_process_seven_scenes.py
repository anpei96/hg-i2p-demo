...
if __name__ == '__main__':
    ...
    base_path = data_dir+"7Scenes/data/chess"
    path_num = 6
    # base_path = data_dir+"7Scenes/data/fire"
    # path_num = 4
    # base_path = data_dir+"7Scenes/data/heads"
    # path_num = 2
    # base_path = data_dir+"7Scenes/data/office"
    # path_num = 10
    # base_path = data_dir+"7Scenes/data/pumpkin"
    # path_num = 8
    # base_path = data_dir+"7Scenes/data/redkitchen"
    # path_num = 14
    # base_path = data_dir+"7Scenes/data/stairs"
    # path_num = 6
    ...
    for idx in range(path_num):
        idx = idx + 1
        spec_path = base_path + "/seq-" + str("%02d" % idx) + "/"
