...
'''
    please revise make_cfg and train_valid_data_loader for training in other scenes
'''
# from .anyscene import I2PHardPairDataset
# from .anyscene_experiment import I2PHardPairDataset
# from .anyscene_kitti_top    import I2PHardPairDataset
from .anyscene_top        import I2PHardPairDataset
# from .anyscene_tum_top    import I2PHardPairDataset
# from .anyscene_keypoints import I2PHardPairDataset
# from dataset.anyscene_tum_odom import I2PHardPairDataset

def train_valid_data_loader(cfg):
    train_dataset = I2PHardPairDataset(
    ...
    valid_dataset = I2PHardPairDataset(
        cfg.data.dataset_dir,
        "val",
...
def test_data_loader(cfg):
    ...
    test_dataset = I2PHardPairDataset(
        cfg.data.dataset_dir,
        "test",
        max_points=cfg.test.max_points,
        return_corr_indices=True,
